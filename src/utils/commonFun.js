...
export default{
  ...
  getChartsData: function(data, type) {
    ...
    for (const i in data.legend) {
      const legs = { name: '', icon: 'circle',
        textStyle: {
          color: '#fff'
        }
      };
