...
export const StaticRouterMap = [
  ...
  { path: '/404', component: () => import('@/views/404'), hidden: true },
  {
    ...
    redirect: '/template1',
    name: 'template1',
    meta: { icon: 'static/images/box1.png' },
    stat: '系统模板',
    children: [
      {
        path: 'template1',
  ...
  },
  {
    ...
    redirect: '/template2',
    name: 'template2',
    meta: { icon: 'static/images/box2.jpg' },
    stat: '系统模板',
    children: [
      {
        path: 'template2',
  ...
  },
  {
    ...
    redirect: '/template',
    name: 'template',
    meta: { icon: 'static/images/box3.png' },
    stat: '系统模板',
    children: [
      {
        path: 'template',
  ...
  /* {
    ...
    redirect: '/template3',
    name: 'template3',
    meta: { icon: 'static/images/box5.png' },
    stat: '系统模板',
    children: [
      {
        path: 'template3',
  ...
  },*/
  {
    ...
    redirect: '/template4',
    name: 'template4',
    meta: { icon: 'static/images/box4.jpg' },
    stat: '系统模板',
    children: [
      {
        path: 'template4',
        component: () => import('@/views/template/template4')
      }
    ]
  }
