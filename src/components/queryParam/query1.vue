  ...
  <div>
    <el-dialog v-dialogDrag :title="textMap[dialogStatus]" :modal="false" :close-on-click-modal="false" :visible.sync="dialogFormVisible" width="50%">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus=='create'" size="mini" type="primary" @click="submitSourData">确定</el-button>
        <el-button v-if="dialogStatus=='update'" size="mini" type="primary" @click="editSourData">确定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
