  ...
  <div>
      <el-dialog v-dialogDrag :title="textMap[dialogStatus]" :modal="false" :close-on-click-modal="false" width="50%" :visible.sync="dialogFormVisible">
        ...
        <div slot="footer" class="dialog-footer">
          ...
          <el-button size="mini" v-if="dialogStatus=='create'"  type="primary" @click="submitSourData">确定</el-button>
          <el-button size="mini" v-if="dialogStatus=='update'"  type="primary" @click="editSourData">确定</el-button>
        </div>
      </el-dialog>
  </div>
</template>
