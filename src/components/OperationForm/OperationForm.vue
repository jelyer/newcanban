<template>
  <div class="rightSetting">
    ...
    <div class="content">
        ...
        <div v-if="!sourSetting" class="form" >
          <el-form id="operationForm" class="operaform" ref="form" :model="form" label-width="5.5rem">
           ...
           <el-form-item label="查询参数">
              <el-tooltip class="item" effect="dark" :content="form.queryparams" placement="top">
                <el-input v-model="form.queryparams" type="textarea" :rows="1" @click.native="openSelectQuery()"></el-input>
              </el-tooltip>
            </el-form-item>
                ...
                <el-row>
                  ...
                  <el-col :span="8" v-for="(item,i) in ableChartsData" :key="i">
                    <div class="imgBox" v-if="dataTypes.indexOf(item.key) > -1 && form.dataKey != null" :title="item.name" @mousedown="chartmouseDown(item.key)" v-on:click="selectionChart(item)">
                      <img v-if="item.key == currKey" class="checked" :src="'static/images/'+(item.url)+'.png'"  alt="" d raggable="true">
      ...
      <!--数据源-->
      <el-dialog v-dialogDrag :title="textMap[dialogStatus]" :modal="false" :close-on-click-modal="false" width="700px" :visible.sync="dialogFormVisible">
        ...
        <!--  <el-form-item label="数据编码" prop="datakey">
          ...
          <el-form-item label="数据名称" prop="dataname">
            <el-input style="width:100%" v-model="dataForm.dataname"></el-input>
          </el-form-item>
        ...
        <!--  <el-form-item label="数据路由" prop="module">
          ...
          <el-form-item label="图表类型" prop="datatype">
            <el-select  style="width:100%"  multiple v-model="dataForm.datatype" placeholder="请选择">
              <el-option-group
          ...
          <el-form-item label="数据配置" prop="dataconfig">
            <el-input style="width:100%" size="mini" v-model="dataForm.dataconfig" type="textarea" :rows="6"></el-input>
          </el-form-item>
        </el-form>
      ...
      <!--选择查询参数-->
      <el-dialog v-dialogDrag title="查询条件" :modal="false" :close-on-click-modal="false" width="700px" :visible.sync="dialogFormParam">
        <el-form :rules="rules" :model="queryForm" status-icon label-position="right" label-width="100px" style='margin:0 30px;'>
          <el-form-item label="查询时间">
            <el-col :span="11">
              <el-date-picker value-format="yyyy-MM-dd HH:mm:ss" type="datetime" placeholder="开始日期" v-model="queryForm.stdate" style="background: none;height:2rem;width:100%"></el-date-picker>
            </el-col>
            <el-col class="line" style="text-align: center;color:#aaa;" :span="2">-</el-col>
            <el-col :span="11">
              <el-date-picker value-format="yyyy-MM-dd HH:mm:ss" type="datetime" placeholder="结束日期" v-model="queryForm.enddate" style="width:100%"></el-date-picker>
            </el-col>
          </el-form-item>
          <el-form-item label="仓库">
            <el-select style="width:100%" clearable class="filter-item"
          ...
          <el-form-item label="Top">
            <el-select style="width:100%" clearable filterable v-model="queryForm.top" placeholder="选择排名" >
...
<script>
  ...
  export default {
    ...
    props:['mainTitle',"queryparams"],//标题
    mounted(){
      this.getTempleteAll();
