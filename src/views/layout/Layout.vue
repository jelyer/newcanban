<template>
  <div :class="classObj" class="app-wrapper">
    ...
    <sidebar :visiblesysModel="visiblesysModel" class="sidebar-container"/>
    ...
    <el-dialog :modal="false" v-dialogDrag title="看板管理" width="60%" :visible.sync="dialogKanbanVisible">
      <el-table
        ...
        height="45vh"
        style="width: 100%;">
        <el-table-column label="模版ID" prop="tempid" :show-overflow-tooltip="true"  align="center" width="150">
    ...
    <!--添加定制化看板页-->
    <el-dialog v-dialogDrag title="添加定制化看板" :modal="false" :close-on-click-modal="false" width="500px" :visible.sync="dialogFormDIY">
      <el-form :rules="rules" ref="diyForm" :model="diyForm" status-icon label-position="right" label-width="100px" style='margin:0 30px;'>
        <el-form-item label="看板ID">
          <el-input style="width:100%" v-model="diyForm.tempid" disabled></el-input>
        </el-form-item>
        <el-form-item label="看板名称" prop="tempname">
          <el-input style="width:100%" v-model="diyForm.tempname"></el-input>
        </el-form-item>
        <el-form-item label="看板地址" prop="tempurl">
          <el-input style="width:100%" v-model="diyForm.tempurl"></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
