  ...
  <div class="box1 template2">
    ...
    <div id="mainBox" class="mainBox" style="z-index:100;position:absolute">
      ...
      <div class="mainContent">
        <div class="firstBox">
          <!--          <div class="ty">
            &lt;!&ndash; 直接使用animated中的动画class名，注意：必须使用animated这个class名，否则动画会无效 &ndash;&gt;
            <div class="box animated bounceInDown"></div>
          </div>-->
          <div class="firstLeft">
            <div :class="[{active: isActive == 0 },'firstLeftBot2']" @click="toEditDiv(domConfig[0])">
          ...
          <div :class="[{active: isActive == 1 },'firstRight']" @click="toEditDiv(domConfig[1])">
        ...
        <div class="secondBox">
          <div :class="[{active: isActive == 2 },'secondRight']" @click="toEditDiv(domConfig[2])">
...
<style scoped>
  ...
  .firstLeft,.firstRight,.secondRight{
    height: 100%;
  ...
  .boxTitle{
    color: #fff;
    border-bottom: 1px solid #19555f;
    opacity: .8;
  }
  .Tb-title{
    color: #00ffd8;
